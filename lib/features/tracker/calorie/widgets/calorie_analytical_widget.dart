        ...
        if (hasSelection)
          Padding(
            ...
            child: Row(
              ...
              children: [
                _buildStatMini("CALORIES", widget.data["calories"]?[_currentIndex], AppColors.crimson),
                _buildStatMini("PROTEIN", widget.data["protein"]?[_currentIndex], Colors.blueAccent),
                _buildStatMini("CARBS", widget.data["carbs"]?[_currentIndex], Colors.greenAccent),
                _buildStatMini("FATS", widget.data["fats"]?[_currentIndex], Colors.orangeAccent),
              ],
            ),
          ),
