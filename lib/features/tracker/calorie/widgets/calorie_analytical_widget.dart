  ...
  LineChartData _buildChartData(bool isCompact) {
    ...
    return LineChartData(
      ...
      gridData: FlGridData(
        ...
        horizontalInterval: ((maxY - minY) / 5).clamp(1, 5000).toDouble(),
...
class CalorieComparisonWidget extends StatelessWidget {
          ...
          if (idx1 != null && idx2 != null) ...[
            ...
            Center(
              child: Text(
                ...
                style: AppTextStyles.labelSmall.copyWith(color: AppColors.textSecondary.withOpacity(0.2), fontSize: isCompact ? 10.sp : 8.0),
              ),
            ),
          ],
        ],
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(title, style: AppTextStyles.labelSmall.copyWith(color: selectedIdx != null ? AppColors.crimson : AppColors.textSecondary.withOpacity(0.4), fontSize: isCompact ? 10.sp : 8.0, fontWeight: FontWeight.w500, letterSpacing: 2)),
              if (selectedIdx != null && !isEnd) ...[
                SizedBox(width: isCompact ? 8.w : 6.0),
                GestureDetector(
                  onTap: () => onChanged(null),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  Icon(selectedIdx != null ? Icons.event_available_rounded : Icons.event_note_rounded, color: selectedIdx != null ? AppColors.crimson : AppColors.textSecondary.withOpacity(0.3), size: isCompact ? 18.r : 16.0),
                  SizedBox(width: isCompact ? 10.w : 8.0),
                  Flexible(child: Text(selectedIdx != null ? labels[selectedIdx] : "SET POINT", overflow: TextOverflow.ellipsis, style: AppTextStyles.labelSmall.copyWith(fontSize: isCompact ? 11.sp : 9.0, color: selectedIdx != null ? Colors.white : AppColors.textSecondary.withOpacity(0.4)))),
                ],
              ),
            ),
          ),
  ...
  Widget _buildComparisonDetails() {
    ...
    final metrics = [
      ...
      {'label': "PROTEIN", 'key': "protein", 'color': Colors.blueAccent, 'unit': "kcal"},
      {'label': "CARBS", 'key': "carbs", 'color': Colors.greenAccent, 'unit': "kcal"},
      {'label': "FATS", 'key': "fats", 'color': Colors.orangeAccent, 'unit': "kcal"},
    ];
  ...
  Widget _valItem(String l, double v, String u, {bool isDelta = false}) {
    return Column(
      children: [
        ...
        Text("${v >= 0 && isDelta ? '+' : ''}${v.round()}$u", style: AppTextStyles.labelMedium.copyWith(color: Colors.white, fontWeight: FontWeight.w500, fontSize: isCompact ? 16.sp : 13.0)),
      ],
    );
  }
}
