        ...
        if (hasSelection)
          Padding(
            ...
            child: Row(
              ...
              children: [
                _buildStatMini("WATER INTAKE", widget.data["water"]?[_currentIndex], Colors.blueAccent),
              ],
            ),
          ),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(title, style: AppTextStyles.labelSmall.copyWith(color: selectedIdx != null ? Colors.blueAccent : AppColors.textSecondary.withOpacity(0.4), fontSize: 11.sp, fontWeight: FontWeight.w900)),
              if (selectedIdx != null && !isEnd) ...[
                SizedBox(width: 8.w),
                GestureDetector(
                  onTap: () => onChanged(null),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: selectedIdx != null ? Colors.blueAccent.withOpacity(0.05) : AppColors.surfaceLight.withOpacity(0.3),
                borderRadius: BorderRadius.circular(12.r),
                border: Border.all(color: selectedIdx != null ? Colors.blueAccent.withOpacity(0.4) : AppColors.white.withOpacity(0.05)),
              ),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(selectedIdx != null ? Icons.event_available_rounded : Icons.event_note_rounded, color: Colors.blueAccent, size: 18.r),
                  SizedBox(width: 10.w),
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.event_note_rounded, color: Colors.blueAccent, size: 24.r),
                ),
                SizedBox(width: 16.w),
                Expanded(
                  child: Column(
                        ...
                        final int? timeResult = await showModalBottomSheet<int>(
                          ...
                          builder: (ctx) => Container(
                            ...
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Text("SELECT TIME", style: AppTextStyles.labelMedium.copyWith(color: Colors.blueAccent, letterSpacing: 1.2)),
                                ...
                                ...indices.map((idx) {
                                  ...
                                  return ListTile(
                                    ...
                                    leading: Icon(
                                      ...
                                      color: isCurrent ? Colors.blueAccent : (isOther ? AppColors.textSecondary.withOpacity(0.5) : AppColors.textSecondary.withOpacity(0.2)),
                                    ),
                                    title: Text(
                      ...
                      child: Row(
                        children: [
                          Icon(
                            ...
                            color: isPartiallySelected ? Colors.blueAccent : (isOccupiedByOther ? Colors.blueAccent.withOpacity(0.5) : AppColors.textSecondary.withOpacity(0.2)),
                            size: 20.r,
                          ),
                          SizedBox(width: 16.w),
                          Text(
  ...
  Widget _valItem(String l, double v, String u, {bool isDelta = false}) {
    return Column(
      children: [
        ...
        SizedBox(height: 4.h),
        Text("${v >= 0 && isDelta ? '+' : ''}${v.round()}$u", style: AppTextStyles.labelMedium.copyWith(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 16.sp)),
      ],
    );
  }
}
