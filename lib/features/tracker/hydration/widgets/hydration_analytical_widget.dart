...
class HydrationComparisonWidget extends StatelessWidget {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(title, style: AppTextStyles.labelSmall.copyWith(color: selectedIdx != null ? Colors.blueAccent : AppColors.textSecondary.withValues(alpha: 0.4), fontSize: isCompact ? 10.sp : 8.0, fontWeight: FontWeight.w500, letterSpacing: 2)),
              if (selectedIdx != null && !isEnd) ...[
                SizedBox(width: isCompact ? 8.w : 6.0),
                GestureDetector(
                  onTap: () => onChanged(null),
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.event_note_rounded, color: Colors.blueAccent.withValues(alpha: 0.5), size: isCompact ? 24.r : 20.0),
                ),
                SizedBox(width: isCompact ? 16.w : 12.0),
                Expanded(
                  child: Column(
                ...
                itemBuilder: (context, i) {
                  ...
                  return GestureDetector(
                        ...
                        final int? timeResult = await showModalBottomSheet<int>(
                          ...
                          builder: (ctx) => Container(
                            ...
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Text("SELECT TIME", style: AppTextStyles.labelMedium.copyWith(color: Colors.blueAccent, letterSpacing: 1.2, fontSize: isCompact ? 13.sp : 11.0)),
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: isPartiallySelected ? Colors.blueAccent.withOpacity(0.1) : AppColors.background.withOpacity(0.5),
                        borderRadius: BorderRadius.circular(isCompact ? 16.r : 12.0),
                        border: Border.all(
                          color: isPartiallySelected ? Colors.blueAccent : (isOccupiedByOther ? Colors.blueAccent.withOpacity(0.3) : AppColors.white.withOpacity(0.05)),
                          width: 1.5,
                        ),
                      ),
                      child: Row(
  ...
  Widget _buildComparisonDetails() {
    ...
    if (v1 != null && v2 != null) {
      items.add(_buildMetricComparison("WATER INTAKE", v1, v2, "ml", Colors.blueAccent));
    }
